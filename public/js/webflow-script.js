  ...
  var Ai = u(() => {
    ...
    window.tram = (function (e) {
      ...
      var lt = e.style,
        ...
        fr = {
          color: [K, w],
          background: [K, w, "background-color"],
          "outline-color": [K, w],
          "border-color": [K, w],
          "border-top-color": [K, w],
          "border-right-color": [K, w],
          "border-bottom-color": [K, w],
          "border-left-color": [K, w],
          "border-width": [q, R],
...
` +
  ...
  var Fs = u((SX, Ds) => {
    "use strict";
    var Ms = $e();
    Ms.define("brand", (Ds.exports = function () {}), function (e) {
      var t = {},
        r = document,
        n = e("html"),
        i = e("body"),
      ...
      t.ready = function () {
        ...
        /\.webflow\.io$/i.test(E) && a.hostname !== E && (h = !0),
          h &&
            !s &&
            ((f = f || d()), g(), setTimeout(g, 500), e(r).off(c, p).on(c, p));
      };
      function p() {
        var h =
          r.fullScreen ||
  ...
  function Ga({
    ...
    if (
      ...
      let P = r && (k || w === !0) ? [r] : c(Q);
      if (k) {
        if (w === v1) return c(k).filter((T) => P.some((N) => g(T, N)));
        if (w === Gh) return c(k).filter((T) => P.some((N) => g(N, T)));
        if (w === Vh) return c(k).filter((T) => P.some((N) => h(N, T)));
      }
      return P;
    }
      ...
      (ni = ie(wt())),
        ...
        (bD = (e, t) => {
          ...
          for (let X = 0, { length: H } = i; X < H; X++) {
            ...
            if ((X === 0 && (O = Q[0]), A >= k)) {
              ...
              let P = i[X + 1],
                T = P && A !== k;
              (w = T ? P.actionItems[0] : null),
                T && ((R = k / 100), (x = (P.keyframe - k) / 100));
            }
          }
          let G = {};
          if (O && !w)
        ...
        (OD = (e, t) => {
          ...
          if (r && n) {
            ...
            if (O < 0) return e;
            let w = ri(Math.min(Math.max(0, O / C), 1)),
              R = rE(m, w, h),
              x = {},
              G = null;
            return (
            ...
            handler: (
              ...
              switch (a) {
                ...
                case Ze.PAGE: {
                  ...
                  S = m ? Math.min(w + h, x) / x : Math.min(R + E, G) / G;
                  break;
                }
                case Ze.ELEMENT:
                default: {
                  ...
                  if (w && rt({ element: t, nativeEvent: n }) !== !0) break;
                  let R = t.getBoundingClientRect(),
                    { left: x, top: G, width: X, height: H } = R;
                  if (!w && !IU({ left: d, top: g }, R)) break;
                  (O = !0), (S = m ? (d - x) / X : (g - G) / H);
                  break;
                }
              }
          ...
          [fU]: {
            ...
            handler: (
              ...
              if (p === Ze.VIEWPORT) {
                let w = O ? o / s : a / c;
                return (
                  w !== i.scrollPercent && t.dispatch(ir(g, w)),
                  { scrollPercent: w }
                );
              } else {
                let w = Lm(n, g),
                ...
                let X = R.top + Math.min(R.height * x, f),
                  k = R.top + R.height * G - X,
                  Q = Math.min(f + k, c),
                  T = Math.min(Math.max(0, f - X), Q) / Q;
                return (
                  T !== i.scrollPercent && t.dispatch(ir(w, T)),
                  { scrollPercent: T }
                );
              }
            },
  ...
  function eX({
    ...
    S.forEach((w) => {
      ...
      C.forEach(({ element: w, key: R }) => {
        let x = m[R],
          G = (0, ut.default)(x, "[0].actionItems[0]", {}),
          { actionTypeId: X } = G,
          H = _i(X) ? ys(X)(w, G) : null,
          k = Es({ element: w, actionItem: G, elementApi: xe }, H);
        ms({
          store: e,
          element: w,
          eventId: n,
        ...
        E.actionTypeId === Ce.GENERAL_CONTINUOUS_ACTION &&
          (Array.isArray(h.config) ? h.config : [h.config]).forEach((O) => {
            let { continuousParameterGroupId: w } = O,
              R = (0, ut.default)(a, `${S}.continuousParameterGroups`, []),
              x = (0, r_.default)(R, ({ id: H }) => H === w),
              G = (O.smoothing || 0) / 100,
    ...
    let c = (d) => {
        ...
        aX(s, (h, E, m) => {
          ...
          A.actionTypeId === Ce.GENERAL_CONTINUOUS_ACTION
            ? (Array.isArray(C.config) ? C.config : [C.config]).forEach(w)
            : w();
        });
      },
      f = (0, s_.default)(c, BU),
          ...
          if (!S.getAttribute("hreflang")) {
            ...
            if (((s.href = A), !(A.indexOf(":") >= 0))) {
              ...
              if (
                ...
                var w = e(s.hash);
                w.length && d.push({ link: O, sec: w, active: !1 });
                return;
              }
              if (!(A === "#" || A === "")) {
                var R =
          ...
          t.each(d, function (O) {
            if (!O.link.attr("hreflang")) {
              var w = O.link,
                ...
                G = R.outerHeight(),
                X = A * 0.5,
                H = R.is(":visible") && x + G - X >= S && x + X <= S + A;
              O.active !== H && ((O.active = H), C(w, c, H));
            }
          });
        }
        function C(S, A, O) {
          var w = S.hasClass(A);
          (O && w) || (!O && !w) || (O ? S.addClass(A) : S.removeClass(A));
        }
        return r;
      })
    );
        ...
        function O(L, V) {
          ...
          if (!te) {
            if (c) {
              M.handler = (() => {
                let re = R_().default;
                return re(R, o, Oi, k, U, G, d, X, x, c, N, e, E);
              })();
              return;
            }
            S();
...
Webflow.require("ix2").init({
  events: {
    e: {
      ...
      target: {
        ...
        originalId: "3af0c89a-23ea-b6b7-e28b-38d85c671d3b",
        appliesTo: "CLASS",
      },
      targets: [
        {
    ...
    "e-3": {
      ...
      target: {
        selector: ".prefooter",
        originalId:
          "6411781e218c5fb46d4cd7bc|995dd39e-a037-1011-ac69-b85fdc157344",
        appliesTo: "CLASS",
      },
      targets: [
        {
          id: "6411781e218c5fb46d4cd7bc|995dd39e-a037-1011-ac69-b85fdc157344",
          appliesTo: "ELEMENT",
          styleBlockIds: [],
        },
      ],
    ...
    "e-4": {
      ...
      target: {
        selector: ".link-light",
        originalId: "c01d1779-547f-03b4-db05-2d3322f294cf",
        appliesTo: "CLASS",
      },
      targets: [
        {
    ...
    "e-6": {
      ...
      mediaQueries: ["main"],
      target: {
        selector: ".footer-scroll-trigger",
        originalId:
          "6411781e218c5fb46d4cd7bc|efffbe8e-cd27-9705-9fe1-7f55a71e99b1",
        appliesTo: "CLASS",
      },
      targets: [
        {
    ...
    "e-7": {
      ...
      target: {
        selector: ".link-dark",
        originalId: "de0970a2-0346-95e6-7bec-492c4f326dc4",
        appliesTo: "CLASS",
      },
      targets: [
        {
    ...
    "e-9": {
      ...
      target: {
        selector: ".scrolling-to-the-left",
        originalId:
          "63c003d333a4b848d1d9e338|be7fce2e-3fe7-6dce-b313-0843325e6371",
        appliesTo: "CLASS",
      },
      targets: [
        {
    ...
    "e-10": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        selector: ".scrolling-to-the-right",
        originalId:
          "63c003d333a4b848d1d9e338|be7fce2e-3fe7-6dce-b313-0843325e6380",
        appliesTo: "CLASS",
      },
      targets: [
        {
    ...
    "e-11": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        selector: ".image-background-parallax",
        originalId:
          "63ed01d60b148f6bdbb2f942|b92b0c8b-21fb-abe0-18b7-204a2c6b6ea9",
        appliesTo: "CLASS",
      },
      targets: [
        {
    ...
    "e-28": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "6411794870f9646a54234c9a|37c44af6-4b5a-46b9-ff50-27f15031981f",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-30": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "6411794870f9646a54234c9a|37c44af6-4b5a-46b9-ff50-27f150319821",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-32": {
      ...
      mediaQueries: ["main"],
      target: {
        id: "6411794870f9646a54234c9a|37c44af6-4b5a-46b9-ff50-27f150319828",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-34": {
      ...
      mediaQueries: ["main"],
      target: {
        id: "6411794870f9646a54234c9a|37c44af6-4b5a-46b9-ff50-27f15031982e",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-36": {
      ...
      mediaQueries: ["main"],
      target: {
        id: "6411794870f9646a54234c9a|37c44af6-4b5a-46b9-ff50-27f150319834",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-38": {
      ...
      mediaQueries: ["main"],
      target: {
        id: "6411794870f9646a54234c9a|37c44af6-4b5a-46b9-ff50-27f15031983a",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-40": {
      ...
      mediaQueries: ["main"],
      target: {
        id: "6411794870f9646a54234c9a|37c44af6-4b5a-46b9-ff50-27f150319840",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-42": {
      ...
      mediaQueries: ["main"],
      target: {
        id: "6411794870f9646a54234c9a|37c44af6-4b5a-46b9-ff50-27f150319846",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-44": {
      ...
      target: {
        ...
        originalId:
          "6411794870f9646a54234c9a|37c44af6-4b5a-46b9-ff50-27f150319828",
        appliesTo: "CLASS",
      },
      targets: [
        {
    ...
    "e-46": {
      ...
      target: {
        selector: ".card",
        originalId:
          "6411794870f9646a54234c9a|fb97763b-54ce-36b9-5e6e-62bcd6dadd37",
        appliesTo: "CLASS",
      },
      targets: [
        {
    ...
    "e-66": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "64133e5470fab1df7091f741|37c44af6-4b5a-46b9-ff50-27f15031981f",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-68": {
      ...
      mediaQueries: ["main"],
      target: {
        id: "64133e5470fab1df7091f741|37c44af6-4b5a-46b9-ff50-27f150319821",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-70": {
      ...
      mediaQueries: ["main"],
      target: {
        id: "64133e5470fab1df7091f741|37c44af6-4b5a-46b9-ff50-27f150319828",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-72": {
      ...
      mediaQueries: ["main"],
      target: {
        id: "64133e5470fab1df7091f741|37c44af6-4b5a-46b9-ff50-27f15031982e",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-74": {
      ...
      mediaQueries: ["main"],
      target: {
        id: "64133e5470fab1df7091f741|37c44af6-4b5a-46b9-ff50-27f150319834",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-76": {
      ...
      mediaQueries: ["main"],
      target: {
        id: "64133e5470fab1df7091f741|37c44af6-4b5a-46b9-ff50-27f15031983a",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-78": {
      ...
      mediaQueries: ["main"],
      target: {
        id: "64133e5470fab1df7091f741|37c44af6-4b5a-46b9-ff50-27f150319840",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-80": {
      ...
      mediaQueries: ["main"],
      target: {
        id: "64133e5470fab1df7091f741|37c44af6-4b5a-46b9-ff50-27f150319846",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-84": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "64133ecdb5958a7530a17a2c|37c44af6-4b5a-46b9-ff50-27f15031981f",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-86": {
      ...
      mediaQueries: ["main"],
      target: {
        id: "64133ecdb5958a7530a17a2c|37c44af6-4b5a-46b9-ff50-27f150319821",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-88": {
      ...
      mediaQueries: ["main"],
      target: {
        id: "64133ecdb5958a7530a17a2c|37c44af6-4b5a-46b9-ff50-27f150319828",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-90": {
      ...
      mediaQueries: ["main"],
      target: {
        id: "64133ecdb5958a7530a17a2c|37c44af6-4b5a-46b9-ff50-27f15031982e",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-92": {
      ...
      mediaQueries: ["main"],
      target: {
        id: "64133ecdb5958a7530a17a2c|37c44af6-4b5a-46b9-ff50-27f150319834",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-94": {
      ...
      mediaQueries: ["main"],
      target: {
        id: "64133ecdb5958a7530a17a2c|37c44af6-4b5a-46b9-ff50-27f15031983a",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-96": {
      ...
      mediaQueries: ["main"],
      target: {
        id: "64133ecdb5958a7530a17a2c|37c44af6-4b5a-46b9-ff50-27f150319840",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-98": {
      ...
      mediaQueries: ["main"],
      target: {
        id: "64133ecdb5958a7530a17a2c|37c44af6-4b5a-46b9-ff50-27f150319846",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-102": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "64133f1d84ec4c7c4cc88752|37c44af6-4b5a-46b9-ff50-27f15031981f",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-104": {
      ...
      mediaQueries: ["main"],
      target: {
        id: "64133f1d84ec4c7c4cc88752|37c44af6-4b5a-46b9-ff50-27f150319821",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-106": {
      ...
      mediaQueries: ["main"],
      target: {
        id: "64133f1d84ec4c7c4cc88752|37c44af6-4b5a-46b9-ff50-27f150319828",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-108": {
      ...
      mediaQueries: ["main"],
      target: {
        id: "64133f1d84ec4c7c4cc88752|37c44af6-4b5a-46b9-ff50-27f15031982e",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-110": {
      ...
      mediaQueries: ["main"],
      target: {
        id: "64133f1d84ec4c7c4cc88752|37c44af6-4b5a-46b9-ff50-27f150319834",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-112": {
      ...
      mediaQueries: ["main"],
      target: {
        id: "64133f1d84ec4c7c4cc88752|37c44af6-4b5a-46b9-ff50-27f15031983a",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-114": {
      ...
      mediaQueries: ["main"],
      target: {
        id: "64133f1d84ec4c7c4cc88752|37c44af6-4b5a-46b9-ff50-27f150319840",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-116": {
      ...
      mediaQueries: ["main"],
      target: {
        id: "64133f1d84ec4c7c4cc88752|37c44af6-4b5a-46b9-ff50-27f150319846",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-120": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "64133fe59477d536ec061186|37c44af6-4b5a-46b9-ff50-27f15031981f",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-122": {
      ...
      mediaQueries: ["main"],
      target: {
        id: "64133fe59477d536ec061186|37c44af6-4b5a-46b9-ff50-27f150319821",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-124": {
      ...
      mediaQueries: ["main"],
      target: {
        id: "64133fe59477d536ec061186|37c44af6-4b5a-46b9-ff50-27f150319828",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-126": {
      ...
      mediaQueries: ["main"],
      target: {
        id: "64133fe59477d536ec061186|37c44af6-4b5a-46b9-ff50-27f15031982e",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-128": {
      ...
      mediaQueries: ["main"],
      target: {
        id: "64133fe59477d536ec061186|37c44af6-4b5a-46b9-ff50-27f150319834",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-130": {
      ...
      mediaQueries: ["main"],
      target: {
        id: "64133fe59477d536ec061186|37c44af6-4b5a-46b9-ff50-27f15031983a",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-132": {
      ...
      mediaQueries: ["main"],
      target: {
        id: "64133fe59477d536ec061186|37c44af6-4b5a-46b9-ff50-27f150319840",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-134": {
      ...
      mediaQueries: ["main"],
      target: {
        id: "64133fe59477d536ec061186|37c44af6-4b5a-46b9-ff50-27f150319846",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-138": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "641340483d66b769a30fcb40|37c44af6-4b5a-46b9-ff50-27f15031981f",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-140": {
      ...
      mediaQueries: ["main"],
      target: {
        id: "641340483d66b769a30fcb40|37c44af6-4b5a-46b9-ff50-27f150319821",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-142": {
      ...
      mediaQueries: ["main"],
      target: {
        id: "641340483d66b769a30fcb40|37c44af6-4b5a-46b9-ff50-27f150319828",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-144": {
      ...
      mediaQueries: ["main"],
      target: {
        id: "641340483d66b769a30fcb40|37c44af6-4b5a-46b9-ff50-27f15031982e",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-146": {
      ...
      mediaQueries: ["main"],
      target: {
        id: "641340483d66b769a30fcb40|37c44af6-4b5a-46b9-ff50-27f150319834",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-148": {
      ...
      mediaQueries: ["main"],
      target: {
        id: "641340483d66b769a30fcb40|37c44af6-4b5a-46b9-ff50-27f15031983a",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-150": {
      ...
      mediaQueries: ["main"],
      target: {
        id: "641340483d66b769a30fcb40|37c44af6-4b5a-46b9-ff50-27f150319840",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-152": {
      ...
      mediaQueries: ["main"],
      target: {
        id: "641340483d66b769a30fcb40|37c44af6-4b5a-46b9-ff50-27f150319846",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-160": {
      ...
      target: {
        ...
        originalId:
          "64133cfba6196a67f632e74b|74a9232d-ac1e-e413-cdcd-b39d2e141b61",
        appliesTo: "CLASS",
      },
      targets: [
        {
    ...
    "e-164": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "64133cfba6196a67f632e74b|518c9fbd-4e8b-12c2-9082-bfd8f6842684",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-166": {
      ...
      mediaQueries: ["main"],
      target: {
        id: "64133cfba6196a67f632e74b|518c9fbd-4e8b-12c2-9082-bfd8f6842686",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-168": {
      ...
      mediaQueries: ["main"],
      target: {
        id: "64133cfba6196a67f632e74b|518c9fbd-4e8b-12c2-9082-bfd8f684268e",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-170": {
      ...
      mediaQueries: ["main"],
      target: {
        id: "64133cfba6196a67f632e74b|518c9fbd-4e8b-12c2-9082-bfd8f6842696",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-172": {
      ...
      mediaQueries: ["main"],
      target: {
        id: "64133cfba6196a67f632e74b|518c9fbd-4e8b-12c2-9082-bfd8f684269f",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-174": {
      ...
      mediaQueries: ["main"],
      target: {
        id: "64133cfba6196a67f632e74b|518c9fbd-4e8b-12c2-9082-bfd8f68426a7",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-176": {
      ...
      mediaQueries: ["main"],
      target: {
        id: "64133cfba6196a67f632e74b|518c9fbd-4e8b-12c2-9082-bfd8f68426af",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-178": {
      ...
      mediaQueries: ["main"],
      target: {
        id: "64133cfba6196a67f632e74b|518c9fbd-4e8b-12c2-9082-bfd8f68426b7",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-180": {
      ...
      target: {
        selector: ".accordion",
        originalId:
          "626fd64c1b057869847ea5a0|6106ff39-55c2-df35-0406-5a8c97d28792",
        appliesTo: "CLASS",
      },
      targets: [
        {
    ...
    "e-182": {
      ...
      mediaQueries: ["main"],
      target: {
        selector: ".friends-link",
        originalId: "12ba8dcf-ad5f-4863-3d47-85b7304057c8",
        appliesTo: "CLASS",
      },
      targets: [
        {
    ...
    "e-184": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "641340483d66b769a30fcb40|c98478fb-b849-c8b6-5d74-2ac4447cab12",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-186": {
      ...
      target: {
        selector: ".card",
        originalId:
          "64133f1d84ec4c7c4cc88752|414c64eb-0321-357b-8090-33779c35b284",
        appliesTo: "CLASS",
      },
      targets: [
        {
    ...
    "e-187": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "641485e7956c56808b7239aa|b083ab91-a138-bd7f-f6a4-15a93c280aa4",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-189": {
      ...
      mediaQueries: ["main"],
      target: {
        id: "641485e7956c56808b7239aa|b083ab91-a138-bd7f-f6a4-15a93c280aa6",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-191": {
      ...
      mediaQueries: ["main"],
      target: {
        id: "641485e7956c56808b7239aa|b083ab91-a138-bd7f-f6a4-15a93c280aae",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-193": {
      ...
      mediaQueries: ["main"],
      target: {
        id: "641485e7956c56808b7239aa|b083ab91-a138-bd7f-f6a4-15a93c280ab6",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-195": {
      ...
      mediaQueries: ["main"],
      target: {
        id: "641485e7956c56808b7239aa|b083ab91-a138-bd7f-f6a4-15a93c280abe",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-197": {
      ...
      mediaQueries: ["main"],
      target: {
        id: "641485e7956c56808b7239aa|b083ab91-a138-bd7f-f6a4-15a93c280ac7",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-199": {
      ...
      mediaQueries: ["main"],
      target: {
        id: "641485e7956c56808b7239aa|b083ab91-a138-bd7f-f6a4-15a93c280acf",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-201": {
      ...
      mediaQueries: ["main"],
      target: {
        id: "641485e7956c56808b7239aa|b083ab91-a138-bd7f-f6a4-15a93c280ad7",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-205": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "6419d399691510590483682c|b0510d21-52b0-a2a9-7c4a-d61f3356efaf",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-207": {
      ...
      mediaQueries: ["main"],
      target: {
        id: "6419d399691510590483682c|b0510d21-52b0-a2a9-7c4a-d61f3356efb1",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-209": {
      ...
      mediaQueries: ["main"],
      target: {
        id: "6419d399691510590483682c|b0510d21-52b0-a2a9-7c4a-d61f3356efb9",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-211": {
      ...
      mediaQueries: ["main"],
      target: {
        id: "6419d399691510590483682c|b0510d21-52b0-a2a9-7c4a-d61f3356efc2",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-213": {
      ...
      mediaQueries: ["main"],
      target: {
        id: "6419d399691510590483682c|b0510d21-52b0-a2a9-7c4a-d61f3356efca",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-215": {
      ...
      mediaQueries: ["main"],
      target: {
        id: "6419d399691510590483682c|b0510d21-52b0-a2a9-7c4a-d61f3356efd2",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-217": {
      ...
      mediaQueries: ["main"],
      target: {
        id: "6419d399691510590483682c|b0510d21-52b0-a2a9-7c4a-d61f3356efda",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-219": {
      ...
      mediaQueries: ["main"],
      target: {
        id: "6419d399691510590483682c|b0510d21-52b0-a2a9-7c4a-d61f3356efe2",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-221": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "6419d2efd77e49351a51f89a|bf142fa4-761d-89e6-e430-193abb569bbd",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-223": {
      ...
      mediaQueries: ["main"],
      target: {
        id: "6419d2efd77e49351a51f89a|bf142fa4-761d-89e6-e430-193abb569bbf",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-225": {
      ...
      mediaQueries: ["main"],
      target: {
        id: "6419d2efd77e49351a51f89a|bf142fa4-761d-89e6-e430-193abb569bc7",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-227": {
      ...
      mediaQueries: ["main"],
      target: {
        id: "6419d2efd77e49351a51f89a|bf142fa4-761d-89e6-e430-193abb569bd0",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-229": {
      ...
      mediaQueries: ["main"],
      target: {
        id: "6419d2efd77e49351a51f89a|bf142fa4-761d-89e6-e430-193abb569bd8",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-231": {
      ...
      mediaQueries: ["main"],
      target: {
        id: "6419d2efd77e49351a51f89a|bf142fa4-761d-89e6-e430-193abb569be0",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-233": {
      ...
      mediaQueries: ["main"],
      target: {
        id: "6419d2efd77e49351a51f89a|bf142fa4-761d-89e6-e430-193abb569be8",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-235": {
      ...
      mediaQueries: ["main"],
      target: {
        id: "6419d2efd77e49351a51f89a|bf142fa4-761d-89e6-e430-193abb569bf0",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-241": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "64197ae61c6359a2f7a1b441|5d32439a-fb9f-e710-1ab0-0ee384a74f78",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-243": {
      ...
      mediaQueries: ["main"],
      target: {
        id: "64197ae61c6359a2f7a1b441|5d32439a-fb9f-e710-1ab0-0ee384a74f7a",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-245": {
      ...
      mediaQueries: ["main"],
      target: {
        id: "64197ae61c6359a2f7a1b441|5d32439a-fb9f-e710-1ab0-0ee384a74f82",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-247": {
      ...
      mediaQueries: ["main"],
      target: {
        id: "64197ae61c6359a2f7a1b441|5d32439a-fb9f-e710-1ab0-0ee384a74f8a",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-249": {
      ...
      mediaQueries: ["main"],
      target: {
        id: "64197ae61c6359a2f7a1b441|5d32439a-fb9f-e710-1ab0-0ee384a74f92",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-251": {
      ...
      mediaQueries: ["main"],
      target: {
        id: "64197ae61c6359a2f7a1b441|5d32439a-fb9f-e710-1ab0-0ee384a74f9a",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-253": {
      ...
      mediaQueries: ["main"],
      target: {
        id: "64197ae61c6359a2f7a1b441|5d32439a-fb9f-e710-1ab0-0ee384a74fa2",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-255": {
      ...
      mediaQueries: ["main"],
      target: {
        id: "64197ae61c6359a2f7a1b441|5d32439a-fb9f-e710-1ab0-0ee384a74fab",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-257": {
      ...
      target: {
        selector: ".card",
        originalId:
          "64133ecdb5958a7530a17a2c|140e5f98-62c1-801d-ceca-c3bec497a18b",
        appliesTo: "CLASS",
      },
      targets: [
        {
    ...
    "e-258": {
      ...
      mediaQueries: ["main"],
      target: {
        id: "64133cfba6196a67f632e74b|5e104239-fb92-34c6-d42a-adcb72c67029",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-259": {
      ...
      mediaQueries: ["main"],
      target: {
        id: "64197ae61c6359a2f7a1b441|0a438170-5c71-88a4-bb43-b062c23141bc",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-260": {
      ...
      mediaQueries: ["main"],
      target: {
        id: "6419d2efd77e49351a51f89a|901f3977-8668-f91d-ec44-babc26423419",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-262": {
      ...
      mediaQueries: ["main"],
      target: {
        id: "6419d399691510590483682c|16d5e889-7dda-754a-5181-55827a76531d",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-265": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "6422aa833ff567b654d6d21e|b0949470-0ccc-bcc2-e49a-a7e1125162ac",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-267": {
      ...
      mediaQueries: ["main"],
      target: {
        id: "6422aa833ff567b654d6d21e|b0949470-0ccc-bcc2-e49a-a7e1125162ae",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-269": {
      ...
      mediaQueries: ["main"],
      target: {
        id: "6422aa833ff567b654d6d21e|b0949470-0ccc-bcc2-e49a-a7e1125162b6",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-271": {
      ...
      mediaQueries: ["main"],
      target: {
        id: "6422aa833ff567b654d6d21e|b0949470-0ccc-bcc2-e49a-a7e1125162be",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-273": {
      ...
      mediaQueries: ["main"],
      target: {
        id: "6422aa833ff567b654d6d21e|b0949470-0ccc-bcc2-e49a-a7e1125162c7",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-275": {
      ...
      mediaQueries: ["main"],
      target: {
        id: "6422aa833ff567b654d6d21e|b0949470-0ccc-bcc2-e49a-a7e1125162cf",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-277": {
      ...
      mediaQueries: ["main"],
      target: {
        id: "6422aa833ff567b654d6d21e|b0949470-0ccc-bcc2-e49a-a7e1125162d7",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-279": {
      ...
      mediaQueries: ["main"],
      target: {
        id: "6422aa833ff567b654d6d21e|b0949470-0ccc-bcc2-e49a-a7e1125162df",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-281": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "6422aa833ff567b654d6d21e|b0949470-0ccc-bcc2-e49a-a7e1125162f2",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-282": {
      ...
      mediaQueries: ["main"],
      target: {
        id: "64133e5470fab1df7091f741|1ad1ef05-0c6a-6537-43dc-ddc43069d9be",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-283": {
      ...
      mediaQueries: ["main"],
      target: {
        id: "6422aa833ff567b654d6d21e|5ceeb7e6-b501-da78-d057-b6ca170bdd20",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-286": {
      ...
      target: {
        selector: ".sidebar-tablet-menu",
        originalId:
          "6411794870f9646a54234c9a|8c631d47-6b49-722f-9cc3-dfa320a9c701",
        appliesTo: "CLASS",
      },
      targets: [
        {
    ...
    "e-288": {
      ...
      mediaQueries: ["medium", "small", "tiny"],
      target: {
        selector: ".sidebar-bg-tablet",
        originalId:
          "6411794870f9646a54234c9a|d80e9109-00b5-940f-bf10-c278bc13dddd",
        appliesTo: "CLASS",
      },
      targets: [
        {
  ...
  actionLists: {
    ...
    "a-3": {
      ...
      createdOn: 1678786426608,
    },
    "a-4": {
      id: "a-4",
      title: "Pre Footer -> Show on Scroll",
      continuousParameterGroups: [
        {
          id: "a-4-p",
          type: "SCROLL_PROGRESS",
              ...
              actionItems: [
                {
                  ...
                  config: {
                    ...
                    target: {
                      selector: ".prefooter",
                      selectorGuids: ["2ff64968-f922-45bd-36d0-d8b50466dc62"],
                    },
                    yValue: -50,
                    zValue: null,
                    xUnit: "PX",
    ...
    "a-5": {
      ...
      createdOn: 1644999861381,
    },
    "a-6": {
      id: "a-6",
      title: "Scrolling Loop [Right]",
      continuousParameterGroups: [
        {
          id: "a-6-p",
          type: "SCROLL_PROGRESS",
    ...
    "a-7": {
              ...
              actionItems: [
                {
                  ...
                  config: {
                    ...
                    target: {
                      useEventTarget: true,
                      id: "63ed01d60b148f6bdbb2f942|b92b0c8b-21fb-abe0-18b7-204a2c6b6ea9",
                    },
                    yValue: -20,
                    xUnit: "PX",
                    yUnit: "%",
      ...
      createdOn: 1676880398418,
    },
    "a-11": {
      id: "a-11",
      title: "Navbar Link -> Hide Active BG",
      actionItemGroups: [
        {
          actionItems: [
            {
              ...
              config: {
                ...
                duration: 200,
                target: {
                  selector: ".navbar-link-active-bg",
                  selectorGuids: ["ad6b4c94-85cb-fa0c-bc5c-4402de141385"],
                },
                value: 1,
                unit: "",
              },
            },
            {
              ...
              config: {
                ...
                duration: 200,
                target: {
                  selector: ".navbar-link-hover-bg",
                  selectorGuids: ["e69d4df1-3dbf-798b-f5c9-bcc631e9bb5b"],
                },
                value: 0,
                unit: "",
              },
    ...
    "a-10": {
      id: "a-10",
      title: "Navbar Link -> Show Active BG",
      actionItemGroups: [
        {
          actionItems: [
            {
    ...
    "a-17": {
      id: "a-17",
      title: "Navbar Link -> Show Active Icon",
      actionItemGroups: [
        {
          actionItems: [
            {
              ...
              config: {
                ...
                target: {
                  ...
                  selector: ".navbar-active-icon",
                  selectorGuids: ["2e077328-3dc5-bf6d-3de0-09185d9fbbcb"],
                },
                value: "none",
              },
            },
          ...
          actionItems: [
            ...
            },
            {
              ...
              config: {
                ...
                target: {
                  useEventTarget: "CHILDREN",
                  selector: ".navbar-inactive-icon",
                  selectorGuids: ["ebdc86fa-228d-1ef6-15a6-d2e0f4b007bd"],
                },
                value: "none",
              },
            },
    ...
    "a-18": {
      id: "a-18",
      title: "Navbar Link -> Hide Active Icon",
      actionItemGroups: [
        {
          actionItems: [
            {
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                target: {
                  useEventTarget: "CHILDREN",
                  selector: ".shine-wrap",
                  selectorGuids: ["efc8ba88-d337-1d87-d7cf-5735f9d3b2ba"],
                },
                value: 0,
                unit: "",
              },
            },
            {
              ...
              config: {
                ...
                target: {
                  useEventTarget: "CHILDREN",
                  selector: ".card-content-vertical",
                  selectorGuids: ["1531fe06-dbc4-ba4f-8058-f4b8b1c045d7"],
                },
                globalSwatchId: "e79c51c2",
                rValue: 28,
                bValue: 28,
                gValue: 28,
                aValue: 1,
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                target: {
                  selector: ".layout",
                  selectorGuids: ["42656349-cb69-972b-b561-1840f7467868"],
                },
                value: 0,
                unit: "",
              },
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                target: {
                  ...
                  selectorGuids: ["1979557c-8ec7-df99-8445-04cb012cfe0c"],
                },
                widthValue: 100,
                heightValue: 0,
                widthUnit: "%",
            ...
            },
            {
              ...
              config: {
                ...
                target: {
                  ...
                  selectorGuids: ["1979557c-8ec7-df99-8445-04cb012cfe12"],
                },
                zValue: 0,
                xUnit: "DEG",
                yUnit: "DEG",
            ...
            },
            {
              ...
              config: {
                ...
                target: {
                  ...
                  selectorGuids: ["1979557c-8ec7-df99-8445-04cb012cfe01"],
                },
                value: 1,
                unit: "",
              },
            },
            {
              ...
              config: {
                ...
                target: {
                  useEventTarget: "CHILDREN",
                  selector: ".accordion-bottom-wrap",
                  selectorGuids: ["1979557c-8ec7-df99-8445-04cb012cfe03"],
                },
                yValue: 50,
                xUnit: "PX",
                yUnit: "%",
    ...
    "a-24": {
          ...
          actionItems: [
            {
              ...
              config: {
                delay: 0,
                easing: [0.26, 0.67, 0.48, 0.91],
                duration: 300,
                target: {
                  useEventTarget: "CHILDREN",
                  selector: ".link-underline",
                  selectorGuids: ["ce52d183-31ff-1f93-7459-aef2cce43539"],
                },
                xValue: -101,
                yValue: null,
                xUnit: "%",
            ...
            },
            {
              ...
              config: {
                ...
                target: {
                  useEventTarget: "CHILDREN",
                  selector: ".icon-svg",
                  selectorGuids: ["44a42096-49c1-979f-d849-23d27b551429"],
                },
                zValue: 45,
                xUnit: "DEG",
                yUnit: "DEG",
      ...
      useFirstGroupAsInitialState: true,
      createdOn: 1620132505879,
    },
    "a-25": {
      id: "a-25",
      title: "Link -> Hide Underline",
      actionItemGroups: [
        {
          actionItems: [
            {
    ...
    "a-26": {
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                target: {
                  useEventTarget: "CHILDREN",
                  selector: ".map-image",
                  selectorGuids: ["bccaeea9-1677-516f-ad14-7415e7918344"],
                },
                value: 0.5,
                unit: "",
              },
            },
            {
              ...
              config: {
                ...
                target: {
                  useEventTarget: "CHILDREN",
                  selector: ".map-outline",
                  selectorGuids: ["710973c2-17b9-b2ae-8959-884a8d5dc02a"],
                },
                value: 0,
                unit: "",
              },
      ...
      useFirstGroupAsInitialState: true,
      createdOn: 1679479377006,
    },
    "a-27": {
      id: "a-27",
      title: "Map -> Opacity Down",
      actionItemGroups: [
        {
          actionItems: [
            {
    ...
    "a-28": {
      ...
      createdOn: 1679496401562,
    },
    "a-29": {
      id: "a-29",
      title: "Card Thumb -> Rotate",
      continuousParameterGroups: [
        {
          id: "a-29-p",
          type: "MOUSE_X",
              ...
              actionItems: [
                {
                  ...
                  config: {
                    ...
                    target: {
                      useEventTarget: "CHILDREN",
                      selector: ".card-thumb-wrap",
                      selectorGuids: ["da297e0e-d1b1-e3fb-db60-b13ce1cae1c7"],
                    },
                    xValue: null,
                    yValue: -6,
                    zValue: null,
    ...
    "a-31": {
      id: "a-31",
      title: "Buy Button -> Hide on Scroll",
      continuousParameterGroups: [
        {
          id: "a-31-p",
          type: "SCROLL_PROGRESS",
              ...
              actionItems: [
                {
                  ...
                  config: {
                    ...
                    target: {
                      selector: ".price-wrap",
                      selectorGuids: ["5e5f5236-e728-f3bb-8660-5e630831ccb1"],
                    },
                    value: 0,
                    unit: "",
                  },
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                target: {
                  selector: ".menu-close",
                  selectorGuids: ["786bd2ba-9b22-04d3-fb65-6d200f4408fb"],
                },
                value: "none",
              },
            },
            {
              ...
              config: {
                ...
                target: {
                  ...
                  selectorGuids: ["b31c9dbf-8010-3eb8-0547-45ef6b63392a"],
                },
                xValue: -100,
                xUnit: "%",
                yUnit: "PX",
            ...
            },
            {
              ...
              config: {
                ...
                target: {
                  selector: ".sidebar-bg-tablet",
                  selectorGuids: ["f3cd51bb-8f7c-f0b1-fc29-6b8521753cbf"],
                },
                value: "none",
              },
            },
            ...
            },
            {
              ...
              config: {
                ...
                target: {
                  ...
                  selectorGuids: ["cba80c5d-f250-0af8-dbbb-6c9756852e4b"],
                },
                value: "none",
              },
            },
